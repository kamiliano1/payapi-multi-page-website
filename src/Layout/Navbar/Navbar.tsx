  ...
  return (
    <nav className="flex w-full ">
      <Image
        src={circle}
        alt=""
        className="absolute w-[780px] h-[780px] sm:w-[949px] sm:h-[949px] lg:w-[780px] lg:h-[780px] object-none top-[-540px] -z-10 lg:left-[800px] lg:top-[-280px] "
      />
      <div className="mt-10 px-6 lg:px-20 flex items-center justify-between md:justify-start w-full ">
