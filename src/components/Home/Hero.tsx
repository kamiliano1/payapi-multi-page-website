...
const Hero: React.FC<HeroProps> = () => {
  return (
    <InAnimation
      cssClasses={`text-center px-6 sm:px-[2.4375rem] mb-20 lg:flex lg:items-center lg:text-start max-w-[1110px] mx-auto z-10 lg:px-0 lg:pt-5`}
    ...
    >
      ...
      <div className="">
        ...
        lg:text-900 lg:mt-[4rem]
        "
        >
          Start building with our APIs for absolutely free.
        </h1>
        <FormEmail />
        <p className="text-100 font-publicSans text-lightSanJuanBlue  lg:mt-2 lg:px-3">
          Have any questions?{" "}
