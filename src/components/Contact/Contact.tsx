...
const Contact: React.FC<ContactProps> = () => {
  return (
    <div className="max-w-[1110px] mx-auto  sm:px-[2.4375rem] lg:px-0  ">
      <div className="text-center lg:text-start mx-auto z-10">
        <h1 className="text-600 px-6 leading-9 font-bold mt-12 mb-10 tracking-[-0.196154px] sm:text-700 lg:text-800 sm:mt-[4.6875rem] max-w-[550px] lg:max-w-[630px] mx-auto lg:mx-0 ">
